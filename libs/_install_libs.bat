...
call mvn install:install-file -Dpackaging=jar -Dversion=2.1.0   -DgroupId=com.aspose        -DartifactId=aspose-diagram    		-Dfile=aspose.diagram-2.1.0.jar

call mvn install:install-file -Dpackaging=jar -Dversion=2.4.0	-DgroupId=com.groupdocs		-DartifactId=groupdocs-viewer		-Dfile=viewer-2.4.0-final.jar
