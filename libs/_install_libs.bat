...
call mvn install:install-file -Dpackaging=jar -Dversion=2.4.1	-DgroupId=com.groupdocs		-DartifactId=groupdocs-viewer		-Dfile=groupdocs-viewer-2.4.1.jar
call mvn install:install-file -Dpackaging=jar -Dversion=1.6.0	-DgroupId=com.groupdocs		-DartifactId=groupdocs-annotation	-Dfile=groupdocs-annotation-1.6.0.jar
