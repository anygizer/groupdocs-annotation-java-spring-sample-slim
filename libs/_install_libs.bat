...
call mvn install:install-file -Dpackaging=jar -Dversion=6.8.0   -DgroupId=com.aspose        -DartifactId=aspose-tasks    		-Dfile=aspose.tasks-6.8.0.jar
...
call mvn install:install-file -Dpackaging=jar -Dversion=1.7.1	-DgroupId=com.groupdocs		-DartifactId=groupdocs-annotation	-Dfile=groupdocs-annotation-1.7.1.jar
